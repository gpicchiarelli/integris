...
anon-unlinked elsewhere) with optional SCM_RIGHTS conferral; provisional session
AEAD with suite negotiation, HMAC peer-auth (`i2r`+`r2i`), and transcript-bound
traffic keys (IP-C-0002). Finished handshake/PQ and IC-1 review remain open.
