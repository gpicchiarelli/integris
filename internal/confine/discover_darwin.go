...
func discoverPlatform() []Finding {
	...
	return []Finding{
		...
		{ID: "DISC-CLONEFILE", Platform: plat, Control: "clonefile", Status: StatusAvailable, Detail: "platform.CloneFile prefers clonefile; degraded copy uses CopyXattr+CopyBSDFlags+CopyACL+CopyResourceFork+CopyTimes (INT-IC4-0001)"},
