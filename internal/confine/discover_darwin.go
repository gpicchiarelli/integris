...
func discoverPlatform() []Finding {
	...
	return []Finding{
		...
		{ID: "DISC-RLIMIT-CORE", Platform: plat, Control: "rlimit_core", Status: StatusAvailable, Detail: "ApplyEngineering sets RLIMIT_CORE soft=hard=0 and verifies getrlimit (M6a)"},
