...
func TestFormatNegativeAck(t *testing.T) {
	ack := confine.FormatNegativeAck([]confine.Finding{
		{ID: "NEG-CAP-MODE", Status: confine.StatusSkipped},
		{ID: "NEG-CAP-AMBIENT", Status: confine.StatusSkipped},
		{ID: "NEG-NO-NEW-PRIVS", Status: confine.StatusSkipped},
		{ID: "NEG-SECCOMP", Status: confine.StatusSkipped},
		{ID: "NEG-DUMPABLE", Status: confine.StatusSkipped},
		{ID: "NEG-RLIMIT-CORE", Status: confine.StatusSkipped},
		{ID: "NEG-TRACE-CTL", Status: confine.StatusSkipped},
		...
		{ID: "NEG-NET-KEYS", Status: confine.StatusSkipped},
		{ID: "NEG-NET-JOURNAL", Status: confine.StatusSkipped},
